...
# `sentence_transformers` import itself takes ~14s (it pulls torch/transformers).
# Nothing in THIS module instantiates a SentenceTransformer — embed_models are
# passed in by the caller. Drop the eager import; loaders can grab it lazily.
from . import config
